        ...
        <div className="tuneup-create-form-container">
            ...
            <form className="tuneup-create-form" onSubmit={handleSubmit}>
                <div className='tuneup-details-container'>
                    ...
                    <textarea className="details-input" type='text' onChange={updates('details')}></textarea>
                </div>
                ...
                <div className='tuneup-address-container'>
                    <h3 className='tuneup-address-header'>Where will your TuneUp take place?</h3>
                    <div className='tuneup-address-input-container'>
                        <div className="tuneup-street-container">
                            ...
                            <input className="tuneup-address-input" type="text" value={streetName} onChange={updates('streetName')} placeholder="123 Main St"></input>
                        </div>
                        <div className="tuneup-city-container">
                            <span className="tuneup-city-label">City</span>
                            <input className="tuneup-city-input" type="text" value={city} onChange={updates('city')} placeholder="New York"></input>
                        </div>
                        <div className="tuneup-state-container">
                            <span className="tuneup-state-label">State</span>
                            <input className="tuneup-state-input" type="text" value={state} onChange={updates('states')} placeholder="NY"></input>
                        </div>
                        <div className="tuneup-zip-code-container">
                            <span className="tuneup-zip-code-label">Zip code</span>
                            <input className="tuneup-zip-code-input" type="text" value={zip} onChange={updates('zip')} placeholder="10019"></input>
                        </div>
                    </div>
                </div>
                <div className='tuneup-instruments-container'>
                    <h3 className='tuneup-instrument-header'>Please select instruments for your TuneUp</h3>
                    <div className="tuneup-instrument-list-container">
                        <div className="tuneup-piano-container">
                            <input className="tuneup-piano-input" type="checkbox" value="piano" checked={pianoChecked} onChange={handlePianoChange}></input>
                            <span className="tuneup-piano-label">Piano</span>
                        </div>
                        <div className="tuneup-guitar-container">
                            <input className="tuneup-guitar-input" type="checkbox" value="guitar" checked={guitarChecked} onChange={handleGuitarChange}></input>
                            <span className="tuneup-guitar-label">Guitar</span>
                        </div>
                        <div className="tuneup-violin-container">
                            <input className="tuneup-violin-input" type="checkbox" value="violin" checked={violinChecked} onChange={handleViolinChange}></input>
                            <span className="tuneup-violin-label">Violin</span>
                        </div>
                        <div className="tuneup-trumpet-container">
                            <input className="tuneup-trumpet-input" type="checkbox" value="trumpet" checked={trumpetChecked} onChange={handleTrumpetChange}></input>
                            <span className="tuneup-trumpet-label">Trumpet</span>
                        </div>
                        <div className="tuneup-flute-container">
                            <input className="tuneup-flute-input" type="checkbox" value="flute" checked={fluteChecked} onChange={handleFluteChange}></input>
                            <span className="tuneup-flute-label">Flute</span>
                        </div>
                        <div className="tuneup-drums-container">
                            <input className="tuneup-drums-input" type="checkbox" value="drums" checked={drumsChecked} onChange={handleDrumsChange}></input>
                            <span className="tuneup-drums-label">Drums</span>
                        </div>
                        <div className="tuneup-saxophone-container">
                            <input className="tuneup-saxophone-input" type="checkbox" value="saxophone" checked={saxChecked} onChange={handleSaxChange}></input>
                            <span className="tuneup-saxophone-label">Saxophone</span>
                        </div>
                        <div className="tuneup-clarinet-container">
                            <input className="tuneup-clarinet-input" type="checkbox" value="clarinet" checked={clarinetChecked} onChange={handleClarinetChange}></input>
                            <span className="tuneup-clarinet-label">Clarinet</span>
                        </div>
                        <div className="tuneup-cello-container">
                            <input className="tuneup-cello-input" type="checkbox" value="cello" checked={celloChecked} onChange={handleCelloChange}></input>
                            <span className="tuneup-cello-label">Cello</span>
                        </div>
                        <div className="tuneup-trombone-container">
                            <input className="tuneup-trombone-input" type="checkbox" value="trombone" checked={tromboneChecked} onChange={handleTromboneChange}></input>
                ...
                <div className='create-tuneup-button-container'>
                    <button className='create-tuneup-button' type='submit'>Create TuneUp!</button>
                </div>
            </form>
